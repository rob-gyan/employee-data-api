const seoAudit = [
  ...
  },
  {
    tableCategory: "TECHNICAL SEO CHECKS (32 checks)",
    tableSubCategory: "",
    checkQuestion: "Does the site have open dynamic pages that can be blocked?",
  ...
  },
  {
    tableCategory: "TECHNICAL SEO CHECKS (32 checks)",
    tableSubCategory: "",
    checkQuestion: "Are any pages being duplicated due to poor architecture?",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "TECHNICAL SEO CHECKS (32 checks)",
  ...
  },
  {
    tableCategory: "TECHNICAL SEO CHECKS (32 checks)",
    tableSubCategory: "",
    checkQuestion: "Can the site be crawled and used without Javascript on?",
  ...
  },
  {
    ...
    checkQuestion: "-- Are all page titles under 65 characters? (570 pixels)",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "MOBILE AUDIT CHECKS (15 checks)",
  ...
  },
  {
    tableCategory: "CONTENT AUDIT (16 checks)",
    tableSubCategory: "",
    checkQuestion: "Are there clear primary and supplementary content types?",
    tool: "Visual",
  },
  {
    tableCategory: "CONTENT AUDIT (16 checks)",
  ...
  },
  {
    tableCategory: "BACKLINKS & ANALYSIS (8 checks)",
    tableSubCategory: "",
    checkQuestion: "Are there large number of backlinks from 1 domain or more?",
    tool: "Ahrefs",
  },
  {
  ...
  },
  {
    tableCategory: "INTERNATIONALISATION (9 checks)",
    tableSubCategory: "",
    checkQuestion: "Does the site location need to be setup in Search Console?",
    tool: "GSC",
  },
  {
    tableCategory: "INTERNATIONALISATION (9 checks)",
  ...
  },
  {
    ...
    tableSubCategory: "",
    checkQuestion: "Does the site need and gain traffic from local audiences?",
    tool: "Client / Research",
  },
  {
    tableCategory: "LOCAL SEO AUDIT (9 checks)",
  ...
  {
    tableCategory: "IMAGE OPTIMISATION (7 checks)",
    tableSubCategory: "",
    checkQuestion: "How many images are used sitewide?",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "IMAGE OPTIMISATION (7 checks)",
    tableSubCategory: "",
    checkQuestion: "Are images being optimised?",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "IMAGE OPTIMISATION (7 checks)",
    tableSubCategory: "",
    checkQuestion: "Are ALT tags being regularly used?",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "IMAGE OPTIMISATION (7 checks)",
    tableSubCategory: "",
    checkQuestion: "Are images named sympathetically?",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "IMAGE OPTIMISATION (7 checks)",
    tableSubCategory: "",
    checkQuestion: "Are there any dead images?",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "IMAGE OPTIMISATION (7 checks)",
    tableSubCategory: "",
    checkQuestion: "Are too many stock images used?",
    tool: "Visual",
  },
  {
    tableCategory: "IMAGE OPTIMISATION (7 checks)",
    tableSubCategory: "",
    checkQuestion: "Are there any images in excess of 100Kb?",
    tool: "Most Crawling Tools",
  },
  {
    tableCategory: "PAGE LEVEL & ELEMENT ANALYSIS (27 checks)",
    tableSubCategory: "",
    checkQuestion: "Are any Deprecated HTML Tags being used?",
    tool: "seositecheckup.com/tools/deprecated-html-tags-test",
  },
